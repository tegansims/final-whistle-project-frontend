...
class Tactics2 extends React.Component {
   ...
   handleDropdownChange = (event, data) => {
    ...
    handleIconClick = () => this.setState({options: !this.state.options})
    ...
    render() { 
        if (!this.props.currentUser) {
            ...
            <Segment.Group className='center aligned segment'>
                <Segment onClick={this.handleIconClick} textAlign='center'> 
                    {this.state.options ? <Icon disabled name='angle double up'  link /> : <Icon name='angle double down'/>}
                </Segment>
        ...
        <div className='pitch' width={window.innerWidth}>
